  ...
  <section class="invoice-preview-wrapper">
    ...
    <b-alert variant="danger" :show="invoiceData === undefined">
      ...
      <div class="alert-body">
        ...
        <b-link class="alert-link" :to="{ name: 'worker-list' }">
          Invoice List
        </b-link>
        for other invoices.
      </div>
            ...
            >
              ...
              <div>
                <div class="logo-wrapper">
                  <logo />
                  <h3 class="text-primary invoice-logo">Standard Mining</h3>
                </div>
              ...
              >
                <div class="invoice-total-wrapper">
                  <div class="invoice-total-item">
                    <p class="invoice-total-title">Total Hash:</p>
                    <p class="invoice-total-amount">180</p>
                  </div>
                  <div class="invoice-total-item">
                    <p class="invoice-total-title">Watt:</p>
                    <p class="invoice-total-amount">1000</p>
                  </div>
                  <div class="invoice-total-item">
